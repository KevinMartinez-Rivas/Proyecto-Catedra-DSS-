...
class Cuenta {
    ...
    public static function dropOneCuenta($NumeroCuenta1, $NumeroCuenta2 = 0) {
        //Creamos el query
        $query = "UPDATE cuenta SET Estado = false WHERE NumeroCuenta = ${NumeroCuenta1}";
