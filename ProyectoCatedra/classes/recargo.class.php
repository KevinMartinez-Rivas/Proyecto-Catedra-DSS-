...
class Recargo {
    ...
    protected static $db;
    protected static $columnaDB = ['CodigoRecargo', 'CodigoCategoriaCuenta', 'OperacionesDisponibles', 'RecargoMensual', 'Estado', 'FechaUltimoRecargo'];
    ...
    public function __construct($args = []) {
        ...
        $this->FechaUltimoRecargo = $args['FechaUltimoRecargo'] ?? '';
    }
    ...
    public static function SetEstado($estado) {
        //Creamos el query
        $query = "UPDATE recargos SET Estado = ${estado} WHERE CodigoCategoriaCuenta = 'AHR'";
