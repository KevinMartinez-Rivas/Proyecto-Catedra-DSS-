...
<main>
    <div class="Contenedor-TituloAdmin g">
        <h2 class="TituloAdmin">Habilitar cuenta bancaria</h2>
    </div>
    ...
    <div class="Contenedor-Errores">
        ...
        <?php endforeach ?>
        <?php if(isset($state) AND empty($errores)){ if($state == 1) echo '<div class="Alerta green">Cuenta creada correctamente</div>'; }?>
    </div>
